...
<div class="row">
  <div class="col-md-10">
    ...
    <div class="card card-primary">
      ...
      <form id="delete_{{ $user->id }}" method="post" action="{{ route('user.destroy', ['id' => $user->id ] ) }}">
        @csrf
        <div class="card-footer">
          <a class="btn btn-outline-danger" data-id="{{ $user->id }}" onclick="deletePost(this)">アカウント削除</a>
        </div>
      </form>
